...
// import { motors } from "../data/data";
import { ICarsFilterOptions } from "../types/types";
...
function FilterCheckbox({
   ...
   * If a user checks multiple motors, the motors (the values of the checkboxes) are joined/concatenated with a '-'.
   *
  ...
  function getCheckboxName() {
    const motorFilters = data.motors;
    if (motorFilters.includes(filter)) {
      return "motor";
    }
    return "brand";
  }
